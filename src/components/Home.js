...
const Home = () => {
    return (
        <div>
        <div className="hero min-h-screen" data-theme="dark" style={{backgroundImage: `url("https://images.pexels.com/photos/3975590/pexels-photo-3975590.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")`}}>
