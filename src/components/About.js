            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        ...
                        <p className="py-6">As we continue to pave the way for the future of the web, we invite you to join us on this exciting journey. Explore the possibilities with Logical Creativity, and let's create something extraordinary together. Thank you for considering us as your partner in the digital realm.</p>
                    </div>
                </div>
            </div>
            <footer className="footer footer-center p-10" data-theme="dark">
                <aside>
